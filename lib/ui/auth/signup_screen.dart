      ...
      body: Center(
        child: Container(
          ...
          child: FormBuilder(
            ...
            child: ListView(             
              children: [
                UIHelper.titleTxtStyle("Welcome !", fntcolor: _colors.primarycolour, fntsize: 22, fntWeight: FontWeight.bold, txtAlign: TextAlign.center),
                UIHelper.titleTxtStyle("Register a new Driver", fntcolor: _colors.primarycolour, fntsize: 20, txtAlign: TextAlign.center),
                ...
                UIHelper().actionButton("Submit", 18, Utils().getWidgetWidth(context) / 2, bgcolour: _colors.primarycolour, onPressed: () {
                  if (_formKey.currentState!.saveAndValidate()) {
                    ...
                    AppController().userregister(context,postParams, profileUrl);
                  }
                }),
